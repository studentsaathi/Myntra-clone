function footer(){
    ...
    <div id="image">
        <h4>EXPRIENCE MYNTRA APP ON MOBILE</h4>
    ...
    <div>
       <div id="last">
        ...
        <div id="right">
            <p> <a href="">100% ORIGINAL</a>  guranttee <br> for all products at myntra.com </p>
        </div>
       </div>
     <div id="last">
        <div>
        ...
        <div id="right">
            <p> <a href="">Return within 30Days</a> of <br>recieving your Orders </p>
        </div>
     </div>
    </div>
</div>
<div id="footer1">
    <div>
        ...
        <p>
            Makeup | Dresses For Girls | T-Shirts | Sandals | Headphones | Babydolls | Blazers For Men | Handbags | Ladies Watches | Bags | Sport Shoes | Reebok Shoes <br> Puma 
             Shoes | Boxers | Wallets | Tops | Earrings | Fastrack Watches | Kurtis | Nike | Smart Watches | Titan Watches | Designer Blouse | Gowns | Rings | Cricket <br> Shoes  Forever 
              21  Eye Makeup | Photo Frames | Punjabi Suits | Bikini | Myntra Fashion Show | Lipstick | Saree | Watches | Dresses | Lehenga | Nike Shoes <br> Goggles | Bras  Suit 
...
<div id="footer2">
 ...
 <div class="footer5">
     ...
     <li>Opportunity to master any domain in fashion with tips from celebrity stylists at Myntra Masterclass sessions.</li>
        <li> collections from celeb stylists.</li>
 </div>
 <div class="footer5">
     <h3>Elite</h3>
 ...
 <div class="footer7">
     <h3>1. Keep Up With What Your Favourite Fashion Icons Are Upto</h3>
 ...
 <div class="footer7" id="footer7">
     <h3>2. Quick Fashion Tip And Tricks</h3>
 ...
 <div class="footer7" id="footer8">
     <h3>3.  Updates on What Is Trending and New Product Launches</h3>
 ...
 <div class="footer7" id="footer8">
     <h3>4. Explicit Step-By-Step Beauty Routines From Experts</h3>
 ...
 <div class="footer7" id="footer8">
     <h3>Celebrity Confessions And A Look Into Their Lives</h3>
